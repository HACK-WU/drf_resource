...
class CollectionsMonitorV3:
    ...
    def __init__(self, client):
        ...
        self.metadata_upgrade_result_table = ComponentAPI(
            ...
            description='将指定的监控单业务结果表升级为全业务结果表',
        )

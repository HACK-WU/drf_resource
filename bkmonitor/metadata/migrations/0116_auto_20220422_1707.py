...
def add_bkunifylogbeat_datasource_option(apps, *args, **kwargs):
    ...
    common_datasource_option = [
        {
            ...
            "value": f"{config.CONSUL_PATH}/influxdb_metrics/{common_data_id}/time_series_metric",
            "value_type": "string",
        }
    ]
    task_datasource_option = [
        {
            "name": "metrics_report_path",
            "value": f"{config.CONSUL_PATH}/influxdb_metrics/{task_data_id}/time_series_metric",
            "value_type": "string",
        }
    ]

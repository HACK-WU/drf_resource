    ...
    def mediatype_create(self):
        ...
        payload = {
            ...
            "params": {
                ...
                # "mediatype.create" added new property "message_templates" in zabbix5.0
                "message_templates": [
                    {
                        "eventsource": 0,
                        "recovery": 0,
                        "subject": self.action_name + " {TRIGGER.NAME}: {TRIGGER.STATUS}",
    ...
    def action_create(self):
        ...
        payload = {
            ...
            "params": {
                ...
                "status": 0,
                "esc_period": 3600,
                # zabbix5.0 dropped support of "def_shortdata", "def_longdata"

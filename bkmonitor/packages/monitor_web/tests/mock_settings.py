...
BKMONIT_MODELS_EVENTACTION_OBJECTS_FILTER = "bkmonitor.models.EventAction.objects.filter"

MONITOR_WEB_ALERT_EVENTS_VIEWS_GET_PERMISSIONS = "monitor_web.alert_events.views.EventCenterViewSet.get_permissions"

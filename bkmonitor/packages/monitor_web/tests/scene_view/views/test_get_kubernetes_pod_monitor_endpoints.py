...
class TestGetKubernetesPodMonitorEndpoints:
    ...
    def test_perform_request(
        ...
        actual = resource.scene_view.get_kubernetes_pod_monitor_endpoints(params)
        expect = [
            {'id': 'http://1.1.1.1:10251/metrics', 'name': 'http://1.1.1.1:10251/metrics'},
            {'id': 'http://2.2.2.2:10251/metrics', 'name': 'http://2.2.2.2:10251/metrics'},
        ]

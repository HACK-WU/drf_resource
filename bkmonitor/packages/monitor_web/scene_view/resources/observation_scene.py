...
class GetObservationSceneList(Resource):
    ...
    def get_collect_plugin_list(cls, bk_biz_id: int) -> list[dict[str, Any]]:
        ...
        for collect_config in collect_configs:
            id__event_group_name_map[collect_config.id] = f"{collect_config.plugin.plugin_type}_{collect_config.plugin.plugin_id}"
        ...
        for collect_config in collect_configs:
            event_group_name: str = f"{collect_config.plugin.plugin_type}_{collect_config.plugin.plugin_id}"

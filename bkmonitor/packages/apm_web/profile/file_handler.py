...
from apm_web.profile.profileconverter import list_profile_parse_converter
...
class ProfilingFileHandler:
    ...
    def parse_file(self, key, profile_id: str, bk_biz_id: int, service_name: str):
        ...
        for c in list_profile_parse_converter():
            try:
                converter = c(
        ...
        try:
            CollectorHandler.send_to_builtin_datasource(profile_id, service_name, profile_data)

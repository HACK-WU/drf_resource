...
clear_sql = """
TRUNCATE TABLE `app_snapshot_host_index`
"""
...
(10,'net','speedRecv','double','system_net','网卡入流量','device_name',1024,'KB/s','system.net.speedRecv',1,1,1),
(14,'net','speedSent','double','system_net','网卡出流量','device_name',1024,'KB/s','system.net.speedSent',1,1,1),
(16,'net','speedPacketsSent','double','system_net','发送包速率','device_name',1,'cps','system.net.speedPacketsSent',1,1,1),
(20,'net','speedPacketsRecv','double','system_net','接收包速率','device_name',1,'cps','system.net.speedPacketsRecv',1,1,1),
...
(86,'disk','r_s','double','system_io','读速率','device_name',1,'cps','system.io.r_s',1,1,1),
(87,'disk','w_s','double','system_io','写速率','device_name',1,'cps','system.io.w_s',1,1,1),
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunSQL(clear_sql), migrations.RunSQL(init_sql)]
